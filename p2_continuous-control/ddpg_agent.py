...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if len(self.memory) > BATCH_SIZE and self.step_cnt >= LEARN_EVERY_N:
            self.step_cnt = 0
            for _ in range(int(LEARN_EVERY_N/2)):
    ...
    def learn(self, experiences, gamma):
        ...
        torch.nn.utils.clip_grad_norm_(self.critic_local.parameters(), 1) # prevent gradient exploration 
